...
<body <?php body_class(); ?>>
	<header class="site-header">
	    <div class="container">
	      <h1 class="school-logo-text float-left"><a href="<?php echo site_url(); ?>"><strong>Tunde's Blog </strong>Site</a></h1>
	      ...
	      <div class="site-header__menu group">
	        <nav class="main-navigation">
	        	...
	        	?> -->
	          <ul>
	            <li <?php if (is_page('about-us') or wp_get_post_parent_id(0) == 4) echo 'class="current-menu-item"' ?> ><a href="<?php echo site_url('/about-us'); ?>">About Us</a></li>
